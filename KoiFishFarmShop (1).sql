...
CREATE TABLE KoiFishCategory (
    ...
    KoiFishId UNIQUEIDENTIFIER FOREIGN KEY REFERENCES KoiFish(Id)
);
...
CREATE TABLE [Order] (
    ...
    Status NVARCHAR(256),
    CreateAt DATETIME,
    DeliveryCompanyId UNIQUEIDENTIFIER FOREIGN KEY REFERENCES DeliveryCompany(Id)
);
...
CREATE TABLE OrderDetail (
    ...
    KoiFishId UNIQUEIDENTIFIER FOREIGN KEY REFERENCES KoiFish(Id),
    KoiFishGroupId UNIQUEIDENTIFIER FOREIGN KEY REFERENCES KoiFishGroup(Id),
    Quantity INT,
    Price INT,
    Plates NVARCHAR(256),
